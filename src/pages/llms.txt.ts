...
- [Chiapas — Tuxtla Gutiérrez](${site.url}/tuxtla/): Sucursales Plaza Cedros y Plaza Crystal. Diagnóstico médico, lentes graduados, Jarmar Eyewear, lentes esclerales.
- [Chiapas — Sucursal Arboledas](${site.url}/tuxtla/arboledas/): Óptica Jarmar en Plaza Cedros, Col. Arboledas, Tuxtla Gutiérrez. Sede clínica con Centro Visual y contactología especializada. Ubicación, horario, teléfono y WhatsApp.
- [Chiapas — Sucursal Plaza Crystal](${site.url}/tuxtla/plaza-crystal/): Óptica Jarmar dentro de Plaza Crystal, Tuxtla Gutiérrez. Desde 1996. Examen de la vista, lentes y boutique Jarmar Eyewear. Ubicación, horario, teléfono y WhatsApp.
